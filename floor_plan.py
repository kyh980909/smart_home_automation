...
devices = [
    PlanDevice(1, "거실 조명", "light", "거실", 420, 460,
               icon_on="assets/icons/light_on.png", icon_off="assets/icons/light_off.png"),
    ...
    PlanDevice(7, "에어컨", "aircon", "거실", 450, 350,
               icon_on="assets/icons/aircon_on.png", icon_off="assets/icons/aircon_off.png"),
    PlanDevice(8, "가스밸브", "gas", "주방", 420, 145,
               icon_on="assets/icons/valve_on.png", icon_off="assets/icons/valve_off.png"),
    PlanDevice(9, "보일러", "boiler", "발코니", 580, 205,
               icon_on="assets/icons/boiler_on.png", icon_off="assets/icons/boiler_off.png"),
    PlanDevice(10, "CCTV", "cctv", "현관", 180, 135,
               icon_on="assets/icons/cctv_on.png", icon_off="assets/icons/cctv_off.png"),
]
